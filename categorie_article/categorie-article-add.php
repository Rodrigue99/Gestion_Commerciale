...
// Renvoie au tableau de bord si l'utilisateur n'a pas accès à categ article add
...
//         break;
//     case 5:
//         addlog("Cons-05-categorie_articlee", "", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
//         break;
// }
...
<head>
  ...
  <title>Gestion commerciale - Ajouter une catégorie d'article</title>
  <!-- plugins:css -->
...
<body>
    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="page-header">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"><a href="categorie_article.php">catégories d'article</a></li>
              <li class="breadcrumb-item active" aria-current="page">ajouter catégorie article</li>
            </ol>
          </nav>
        </div>
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Ajouter une catégorie d'article dans la liste</h4>
              <p class="card-description">
                Ajout des informations essentielles d'une catégorie d'article
              </p>
              <form class="forms-sample" method="POST" id="categorie_article_add" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      <label for="exampleInputName1">Nom de la catégorie d'article*</label>
                      <input type="text" name="nom_categorie_article" class="form-control" id="exampleInputName1" placeholder="Nom" required>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="form-group">
                      <label for="exampleInputName1">Description</label>
                      <input type="text" name="description_categorie_article" class="form-control" id="exampleInputName1" placeholder="Description" required>
                    </div>
                  </div>
                </div><br>
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="nombre_article_categorie_article" class="form-control" id="exampleInputName1" placeholder="nombre d'articles" required>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="form-group">
                      <label>Photo</label>
                      <input type="file" name="photo_categorie_article" class="file-upload-default">
  ...
  <script>
    $(document).on('submit', '#categorie_article_add', function(event) {
