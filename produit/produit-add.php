...
// Renvoie au tableau de bord si l'utilisateur n'a pas accès à produit add
...
switch ($_SESSION['type_user']) {
    ...
    case "Super Administrateur":
        addlog("Ajout-01-article", "", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
        break;
    case "Administrateur":
        addlog("Ajout-02-article", "", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
        break;
    case "Editeur":
        addlog("Ajout-03-article", "", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
        break;
    case "Auteur":
        addlog("Ajout-04-article", "", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
        break;
    case "Lecteur":
        addlog("Ajout-05-article", "", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
        break;
}
...
<head>
  ...
  <title>Gestion commerciale - Ajouter Produit</title>
  <!-- plugins:css -->
...
<body>
        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" method="POST" id="produit_add" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-4">
                  ...
                  <div class="col-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="code_barre_produit" class="form-control" placeholder="code barre" required>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="form-group">
                      <label for="exampleInputName1">Référence</label>
                      <input type="text" name="reference_produit" class="form-control" placeholder="reference" required>
                    </div>
                  </div>
                </div><br>
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <select class="form-control form-control-lg" name="categorie_produit" required>
                        <?php
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="cout_de_revient_produit" class="form-control" placeholder="coût de revient" required>
                    </div>
                  </div>
                </div><br>
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="prix_de_vente_produit" class="form-control" placeholder="Prix de vente" required>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="form-group">
                      <label>Photo</label>
                      <input type="file" name="photo_produit" class="file-upload-default" accept="image/png, image/jpg, image/jpeg, image/PNG, image/JPG, image/JPEG">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <textarea name="note_produit" id="exampleTextarea1" cols="30" rows="10" class="form-control" required></textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <!-- <div class="form-group">
                      <label>Photo</label>
                      <input type="file" name="photo_produit" class="form-control" required accept="image/png, image/jpg, image/jpeg, image/PNG, image/JPG, image/JPEG">
                    </div> -->
  ...
  <script>
    $(document).on('submit', '#produit_add', function(event) {
