...
if(isset($_POST['btn_export_categorie_produit'])) {

    if($_POST['export_categorie_produit'] == 'pdf') {

        $query = "
        SELECT * 
        FROM categorie_produit WHERE deleted = 0
        ";
        ...
        <b>Liste des categories d\'article à la date du '.$date.' à '.$hour.'</b>
        ...
        $output .= '
                <tr>
                <td>'.$row["id_categorie_produit"].'</td>
        ...
        // } else {
            $file_name = 'Liste des categories d\'article_'.$date.'_'.$hour2.'.pdf';
        //}
        ...
        switch ($_SESSION['type_user']) {
            ...
            case "Super Administrateur":
                addlog("Exp-01-produit", "PDF", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
                break;
            case "Administrateur":
                addlog("Exp-02-produit", "PDF", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
                break;
        }
    }


    if($_POST['export_categorie_produit'] == 'word') {
        ...
        // } else {
            $file_name = 'Liste des categories d\'article_'.$date.'_'.$hour2.'.docx';
        //}
        ...
        switch ($_SESSION['type_user']) {
            ...
            case "Super Administrateur":
                addlog("Exp-01-produit", "Word", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
                break;
            case "Administrateur":
                addlog("Exp-02-produit", "Word", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
                break;
        }
    ...
    if($_POST['export_categorie_produit'] == 'excel') {
       ...
       WHERE deleted=0
        ...
        // } else {
            $file_name = 'Liste des categorie_produit_'.$date.'_'.$hour2.'.xls';
        //}
        ...
        switch ($_SESSION['type_user']) {
            ...
            case "Super Administrateur":
                addlog("Exp-01-produit", "Ecxel", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
                break;
            case "Administrateur":
                addlog("Exp-02-produit", "Ecxel", $_SESSION["prenom_user"]." ".$_SESSION["nom_user"]);
                break;
        }
